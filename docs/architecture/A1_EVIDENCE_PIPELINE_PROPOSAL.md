...
**`STATIC` 분석은 v0.1 에서 꺼져 있다.** 노이즈 비율이 검증되지 않았고 **문제 지표는 최대 3행**이다 —
...
|---|---|---|---|---|
| **FULL — v0.1 출시 지원** | **경계 하나짜리 로컬 웹 애플리케이션 · 로컬 실행/dev 명령을 발견할 수 있는 것.** 프레임워크 중립 (Next · Vite · React · Vue · Svelte · 정적 · 동등물) | ✅ | ✅ 라우트 단위 | ✅ 있으면 |
