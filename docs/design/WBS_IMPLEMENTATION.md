...
단위 591/591 · e2e 4개 스위트 통과. **미결: Canon 갱신 3건** (ERD.md §5).
...
**창업자 결정이 막고 있는 것 1건:** P4-1 — Windows 호스트. (P1-1 · P3-3 은 2026-09-12 에 결정됨: D-A7 · D-A6)
